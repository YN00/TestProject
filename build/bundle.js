...
react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Root__WEBPACK_IMPORTED_MODULE_2__["default"], null), document.getElementById("root"));
...
if (true) {
  (function () {
    ...
    var checkPropTypes = __webpack_require__(4); // TODO: this is special because it gets imported during build.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */if(true){(function(){'use strict';var React=__webpack_require__(1);var _assign=__webpack_require__(3);var Scheduler=__webpack_require__(8);var checkPropTypes=__webpack_require__(4);var tracing=__webpack_require__(10);// Do not require this module directly! Use normal `invariant` calls with
// template literal strings. The messages will be replaced with error codes
// during build.
/**
 * Use invariant() to assert state which your program assumes to be true.
